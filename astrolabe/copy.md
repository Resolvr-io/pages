# Astrolabe Landing Page Copy

---

## Hero

Chart a new course to sustainable bitcoin yield.

Earn yield from the real world. Allocate a portion of your treasury to back the insurance operations of licensed carriers and participate in the profits of the global reinsurance market.

---

## The Investor Advantage: Why Allocate to the Astrolabe Risk Asset Marketplace?

### Uncorrelated Returns

Escape crypto market volatility. Risk asset returns are driven by natural events and standard insurance risk, which have zero correlation to bitcoin price action or DeFi lending cycles.
...
Unlike traditional reinsurance funds, the Astrolabe Risk Asset Marketplace utilizes on-chain covenants. You can cryptographically verify that your collateral is held in the correct reserve address at all times.

### Atomic Liquidity

Tokenized risk asset notes can be traded on secondary markets or peer-to-peer using atomic swaps, offering superior liquidity to traditional multi-year reinsurance contracts.
...
Select your allocation and perform a single, atomic transaction swapping L-BTC for the specific risk asset token.
...
At maturity, the principal is unlocked and returned. Need liquidity sooner? Swap your risk asset token on the secondary market.

---

## Put your treasury to work.

See the compounding potential of allocating a portion of your idle bitcoin holdings to a diversified risk asset portfolio.

*Projections are estimates based on historic risk asset market performance. Past performance is not indicative of future results.

---

## CTA

Become an Astrolabe Treasury Partner
...
Everything you need to know about investing in the Astrolabe Risk Asset Marketplace

### The Fundamentals

**Where does my bitcoin go if I buy a risk asset? (AKA "Who's holding my bitcoin"?)**
...
**Is the yield paid in bitcoin or fiat?**
...
Due to the regulatory nature of securities and insurance, this product is available only to accredited and institutional investors who have been whitelisted by Astrolabe. While the risk asset is unilaterally redeemable for L-BTC upon maturity, the issuance and movement of the risk asset before then is gated and permissioned by Astrolabe. You must undergo a standard KYC/AML process to be authorized to participate in the primary issuance or secondary trades.

### Technology & Security

**How is this different from other smart contract platforms (e.g., Ethereum/Solidity)?**

The Astrolabe Risk Asset Marketplace is built on the Liquid Network, a Bitcoin sidechain, using SimplicityHL (High-Level Simplicity). This differs from EVM-based platforms (like Ethereum) in two critical ways:

1. **Safety & Auditability:** Simplicity is designed to be formally verifiable, significantly reducing the risk of bugs, hacks, or "rug pulls" common in Solidity-based contracts.
2. **bitcoin-Native Architecture:** The contract uses a UTXO-based model (similar to Bitcoin) rather than an Account model. This allows for precise state management where the token supply and the backing collateral are mathematically linked and move in lockstep, ensuring the token supply always matches the backing collateral.

**How is a payout triggered?**
...
**What happens if Astrolabe goes out of business?**

Your assets are safe. Because the arrangement is structured as a decentralized smart contract on the Liquid blockchain, the custody of funds is not dependent on Astrolabe's continued existence. The Redemption path is hard-coded to allow token holders to burn their tokens and reclaim their bitcoin collateral after the Expiry Date, regardless of Astrolabe's operational status.

### Liquidity

**Can I sell my position before the bond matures?**

Yes. Unlike traditional private reinsurance contracts which are illiquid, the risk asset is issued as a token on the Liquid Network. This enables peer-to-peer trading. You can sell your position to another whitelisted investor using an atomic swap, a single, instantaneous transaction where the risk asset token and the bitcoin payment are exchanged simultaneously. This eliminates settlement delays and settlement risk.
